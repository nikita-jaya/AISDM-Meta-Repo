...
selected_file = "facebook_pop_aggregated_bing.parquet"
...
scatter_df = load_data("facebook_pop_bing.parquet")
...
df["county_geoid"] = (
    pd.to_numeric(df["county_geoid"], errors="coerce")
    .astype("Int64")
    .astype(str)
    .str.zfill(5)
)
counties_sf["county_geoid"] = counties_sf["county_geoid"].astype(str)
...
with tab_info:
    ...
    video_file = open("fire_animation.mp4", "rb")
